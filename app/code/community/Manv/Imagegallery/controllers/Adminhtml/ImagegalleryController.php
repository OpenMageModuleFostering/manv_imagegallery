...
class Manv_Imagegallery_Adminhtml_ImagegalleryController extends Mage_Adminhtml_Controller_Action
{
		...
		{
				$this->loadLayout()->_setActiveMenu("imagegallery/imagegallery")->_addBreadcrumb(Mage::helper("adminhtml")->__("Imagegallery  Manager"),Mage::helper("adminhtml")->__("Imagegallery Manager"));
				return $this;
		}
		...
		{			    
				...
				if ($model->getId()) {
					...
					$this->loadLayout();
					$this->_setActiveMenu("imagegallery/imagegallery");
		...
		if ($_FILES['image']['name']) {
			...
			if($this->getRequest()->getParam("id")){
				...
				if($model->getData('image')){
						...
						$path = Mage::getBaseDir('media') . DS . 'imagegallery' . DS .'imagegallery'.DS;
						...
						$post_data['image']='imagegallery/imagegallery/'.$filename;
		}
    }
}
...
//save image
		...
		public function exportCsvAction()
		{
			...
			$grid       = $this->getLayout()->createBlock('imagegallery/adminhtml_imagegallery_grid');
